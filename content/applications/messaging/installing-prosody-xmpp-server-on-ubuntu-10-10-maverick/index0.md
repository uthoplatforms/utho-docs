...
Ensure that the modules_enabled table includes essential global modules to provide basic functionality.

To deactivate a virtual host without deleting it from the configuration file, insert the following line into its section:
