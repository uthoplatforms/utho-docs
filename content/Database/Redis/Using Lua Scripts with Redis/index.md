---
slug: Using Lua Scripts with Redis
...
Create a Utho Account and Compute Instance: If you haven't already, start by creating a Utho account and setting up your Compute Instance. Refer to our Getting Started with Utho and Creating a Compute Instance guides for detailed instructions.

Set Up and Secure Your Compute Instance: Follow our Setting Up and Securing a Compute Instance guide to update your system. This includes configuring timezone settings, hostname, creating a limited user account, and securing SSH access.

Install Redis Server: Proceed with our How to Install a Redis Server guide to install Redis server and CLI tools. Make sure to select your Linux distribution from the drop-down menu at the top of the page to view the relevant installation steps.
...
Ready to dive into Lua scripting on your Redis server? This tutorial will guide you through writing, deploying, and managing scripts effectively.

Looking to expand your Redis knowledge further? Explore our Redis guides for insights into Redis data types, configurations, and more.