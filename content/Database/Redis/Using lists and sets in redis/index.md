---
slug: Using lists and sets in redis
...
Redis is an open-source NoSQL database known for its high performance in caching, messaging, and other scenarios where speed and low latency are essential.

Redis offers various data types for handling collections, with Lists and Sets being among the most common. This tutorial explains what Redis Lists and Sets are and demonstrates how to use them.

Additionally, be sure to check out our other guides in this series, including the previous guide on Connecting to Redis and Using Redis Databases.
...
Update your system by following our Setting Up and Securing a Compute Instance guide. Additionally, you may want to set the timezone, configure your hostname, create a limited user account, and harden SSH access.
...
This guide is designed for non-root users. Commands that require elevated privileges are prefixed with sudo. If you're unfamiliar with the sudo command, refer to the Linux Users and Groups guide.
{{< /note >}}
...
Sorted Sets offer a variety of commands and methods to interact with their collections. To explore how Sorted Sets function and begin utilizing them, check out our How to Use Sorted Sets in Redis guide.
