...
{{< note >}}
This guide is intended for a non-root user. Commands that require elevated privileges are prefixed with sudo. If you're unfamiliar with the sudo command, refer to our Users and Groups guide for more information.
{{< /note >}}
