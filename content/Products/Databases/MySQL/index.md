...
3.  After clicking it will redirect user to the database homepage.
...
![MYSQL_Process](../Screenshots/MYSQL_Process.png)

After clicking on the manage a new screen will occur.
![MYSQL_Process_01](../Screenshots/MYSQL_Process_01.png)
<br />
